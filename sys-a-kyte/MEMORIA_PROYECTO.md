...
**Se sube CSV, se baja Excel.** Shopify solo exporta en CSV, así que la subida sigue siendo `.csv`. La descarga es `.xlsx` (botón "Bajar Excel actualizado") — Kino lo convierte a CSV a mano cuando lo necesita para resubir a Shopify. Antes bajaba directo en `.csv`; se cambió a pedido de Kino el 21 sep 2026.
